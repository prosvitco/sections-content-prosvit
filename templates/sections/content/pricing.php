...
<section id="pricing" class="pricing-section section">
	<div class="container">
      <?php if( !empty($content_pricing_title) ): ?>
        <h2 class="section-heading text-center"><?php echo $content_pricing_title; ?></h2>
      <?php endif; ?>	
      <?php if( !empty($content_pricing_subtitle) ): ?>
		...
		<!-- PRICING TABLE -->
			...
			<?php if( have_rows('content_pricing_list') ): $i=0;?>
				...
				<?php while ( have_rows('content_pricing_list') ) : the_row(); ?>
					...
					$content_pricing_animation = get_sub_field('content_pricing_animation');
					?>     
					<div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-0 pricing-cell" data-animation="<?php echo $content_pricing_animation; ?>">
